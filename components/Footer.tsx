        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-20">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/shop" className="text-sm text-gray-500 hover:text-gold-600 transition-colors">Shop All</Link></li>
              <li><Link href="/privacy" className="text-sm text-gray-500 hover:text-gold-600 transition-colors">Privacy Policy</Link></li>
              <li><Link href="/shipping" className="text-sm text-gray-500 hover:text-gold-600 transition-colors">Shipping & Returns</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gold-50 pt-12 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-8">
             <div className="flex items-center gap-2">
               ...
               <span className="text-xs font-black text-gray-600">CASHFREE</span>
             </div>
          </div>
        </div>
      </div>
