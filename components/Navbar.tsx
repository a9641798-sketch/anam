        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="flex items-center justify-end gap-2 md:gap-4 flex-1">
              ...
              {/* Wishlist */}
              <Link href="/wishlist" className="hidden md:block p-2.5 text-gray-700 hover:text-gold-600 transition-colors rounded-xl hover:bg-gold-50" aria-label="Wishlist">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* User Account */}
              <Link href="/my-account" className="hidden md:block p-2.5 text-gray-700 hover:text-gold-600 transition-colors rounded-xl hover:bg-gold-50" aria-label="My Account">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Cart */}
              <Link href="/cart" className="relative p-2 md:p-2.5 text-gray-700 hover:text-gold-600 transition-colors rounded-xl hover:bg-gold-50">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                </svg>
                {cartCount > 0 && (
                  <span className="absolute -top-0.5 -right-0.5 md:-top-1 md:-right-1 min-w-[18px] h-[18px] bg-gold-600 text-white text-[10px] font-bold rounded-full flex items-center justify-center px-0.5">
