        ...
        <div className="max-w-7xl mx-auto px-4">
          <FadeIn className="text-center mb-16">
            <h1 className="font-heading text-4xl md:text-5xl text-gray-900 uppercase tracking-wider mb-4">
              New <span className="text-gold-500 italic font-light">Arrivals</span>
            </h1>
            <p className="text-gray-500 uppercase tracking-widest text-sm">The latest additions to our royal collection</p>
          </FadeIn>
